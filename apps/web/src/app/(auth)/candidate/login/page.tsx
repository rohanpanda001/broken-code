        ...
        <div className="bg-cloud/5 border border-cloud/10 rounded-xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-cloud text-charcoal font-semibold rounded-md hover:bg-cloud/90 transition-all"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-[#24292e] text-white font-semibold rounded-md hover:bg-[#2f363d] border border-white/10 transition-all"
            >
